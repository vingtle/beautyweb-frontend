...
const treatmentCategories = [
    {
        ...
        }, 
        {
          ...
          treatments: [
              { id: 1, subcategory: "facewax", name: "Face Wax Options", description: "EyeBrows; ForeHead; UpperLip; Chin", price: "from 10€" },
              { id: 2, subcategory: "armwax", name: "Arm Wax Options", description: "Half Arm; Full Arm", price: "from 15€" },
              { id: 3, subcategory: "legwax", name: "Leg Wax Options", description: "Half Legs; Thighs; Tree/Four Legs; Full Legs", price: "from 20€" },
              { id: 4, subcategory: "upperbodywax", name: "Upper Body Wax Options", description: "Underarms; Stomach; Back", price: "from 15€" },
              { id: 5, subcategory: "bikiniwax", name: "Bikini Wax Options", description: "Classic; Extended; Full", price: "from 15€" },
              { id: 6, subcategory: "ladiespackages", name: "Ladies Wax Packages", description: "Combo: Half Legs + Underarms + Extended Bikini; Combo: Half Legs + Underarms + Full Bikini; Combo: Full Legs + Underarms + Full Bikini; Full Body", price: "from 50€" },
          ],
      },
];
...
const skincareCategory = {
  ...
  treatments: [
    { id: 1, name: "Skin Cleansing Care", duration: "15 min", price: "15 €", description: "A deep cleansing treatment to rejuvenate your skin." },
    { id: 2, name: "Eyes Contour Care", duration: "20 min", price: "25 €", description: "A targeted treatment for reducing puffiness and dark circles." },
    { id: 3, name: "Express Facial", duration: "30 min", price: "35 €", description: "Quick and refreshing facial for a glowing complexion." },
    {
      id: 4,
      name: "Regenerating Treatment",
      duration: "60 min",
...
const eyeslashCategory = {
  title: "Eye Lash Extension Nature Look",
  treatments: [
    {
      id: 1,
      name: "Eye Lash Extension Nature Look",
...
const treatmentCategories = [
  { id: 1, category: skincareCategory },
  { id: 2, category: hairscalpCategory },
  { id: 3, category: waxingCategory },
  { id: 4, category: nailsCategory},
  { id: 5, category: massagesCategory},
  { id: 6, category: eyeslashCategory},
];
